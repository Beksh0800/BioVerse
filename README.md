...
**Вертикальный запас на бланке — около нуля для демонстрационных данных.** Печать увеличена, а нижняя строка (номер/девиз/QR) сдвинута ниже; на текущих демо-значениях (`Аружан Серікқызы`, «Өсімдіктердің фотосинтезі») всё помещается впритык. У заметно более длинного ФИО или названия проекта (переносящихся на две строки) запаса уже не хватит, и лишнее обрежется контейнером — в худшем случае вместе с QR. Если планируете вводить на защите реальные длинные имена, проверьте их заранее теми же командами выше.
